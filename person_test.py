...
class PersonTest():
    ...
    def test_person(self):
        ...
        assertEqual test_person.name == expected_person_name
        assertEqual test_person.age == expected_person_age
        assertEqual test_person.height == expected_person_height
        assertEqual test_person.favourite_drink == expected_person_drink
#if __name__ == "main":
#    unittest.main()